...
Scrpit Purpose :
         ...
         The Gold layer represents final and fact tables (Star Schema)
...
pr.product_key,--------------removing sd.sls_prd_key -> pr.product_key
cu.customer_key,---------------removing sd.sls_cust_id->cu.customer_key
